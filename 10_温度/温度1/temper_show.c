...
{
	posi(2,4);
	if(temper1_h>=100)wdat(7);
	else wdat(0x30+temper1_h);
	wdat(0x30+temper1_l);
	posi(2,7);wdat(0x30+temper1_0h);wdat(0x30+temper1_0l);
	posi(2,10);
	if(temper2_h>=100)wdat(7);
	else wdat(0x30+temper2_h);
	wdat(0x30+temper2_l);
...
void ds_lcd03()//模式3显示
{
	...
	posi(2,1);wdat(' ');wdat(' ');
	posi(2,3);
	wdat(0x30+temper_limit[0][0]);
	wdat(0x30+temper_limit[0][1]);
	posi(2,6);
	wdat(0x30+temper_limit[0][2]);
	wdat(0x30+temper_limit[0][3]);
	posi(2,8);wdat(' ');wdat(' ');
	//显示最小值
	posi(2,10);
	wdat(0x30+temper_limit[1][0]);
	wdat(0x30+temper_limit[1][1]);
	posi(2,13);
	wdat(0x30+temper_limit[1][2]);
	wdat(0x30+temper_limit[1][3]);
	posi(2,15);wdat(' ');wdat(' ');
